...
def user_posts(username):
    ...
    return render_template('user_posts.html', user_posts=posts, user=user)
...
def send_reset_email(user): 
    ...
    message.body = f'''
        ...
        If you did not make this request, just simply ignore this email and no changes will be made
    '''
    mail.send(message)
...
def reset_token(token):
    ...
    if user is None:
        flash('This is an invalid or expired toekn', 'warning')
